    ...
    <div>
      ...
      <v-card class="mx-auto pa-12 pb-8" elevation="8" max-width="448" rounded="lg">
        ...
        <v-text-field density="compact" placeholder="Correo electrónico" autocomplete="off"
          prepend-icon="mdi-email-outline" variant="outlined"></v-text-field>
        ...
        <v-text-field :append-inner-icon="visible ? 'mdi-eye-off' : 'mdi-eye'" :type="visible ? 'text' : 'password'"
          ...
          @click:append-inner="visible = !visible" autocomplete="off"></v-text-field>
        ...
        <v-btn small class="mb-8" color="blue-darken-4" size="large" variant="tonal" block @click="iniciarSesion()">
          Iniciar sesión
        </v-btn>
...
const iniciarSesion = async () => {
  try {
    ...
    // Aquí podrías usar un SweetAlert2 para mostrar el error bonito
  }
}
</script>
